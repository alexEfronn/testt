			...
			<div class="game-component">
				<div class="game-block">
					...
					<div class="game-area__wrap">
						<div class="game-area">
							<div class="game-area-content">
								<div class="crash__connected">
									<canvas id="crashChart" height="299" width="434" style="width: 100%; height: auto;"></canvas>
						...
						<div class="bet-component bet-component-crash">
	                        <div class="bet-form">
	                            <div class="form-row">
	                                <label>
	                                    <div class="form-label"><span>Сумма ставки</span></div>
	                    ...
	                    <div class="history">
	                    	<div class="form-label" style="margin-bottom: 11px;"><span>История игр</span></div>
