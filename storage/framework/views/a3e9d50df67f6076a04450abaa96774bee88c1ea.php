...
<body>
	<div class="logo">
		...
		<a href="https://vk.com/win2xru" class="vk" target="_blank"><span>Перейти в группу </span><i class="fab fa-vk"></i></a>
	</div>
</body>
<?php else: ?>
<!DOCTYPE html>
...
<!--
                                <li>
                                    <a class="<?php echo e(Request::is('tasks') ? 'isActive' : ''); ?>" href="/tasks">
...
<!--
                    <li class="<?php echo e(Request::is('binary') ? 'current' : ''); ?>">
                        <a class="" href="/binary">
                            <svg class="icon">
                                <use xlink:href="/img/symbols.svg#icon-binary"></use>
                            </svg>
                            <div class="side-nav-tooltip">Binary</div>
                        </a>
                    </li>
-->
                </ul>
...
<!--
                                <div class="message-block quiz" id="chatm_">
                                        ...
                                        <div>
                                            <div class="message-text">
												<span class="quizLabel">
													<svg class="icon icon-success"><use xlink:href="/img/symbols.svg#icon-success"></use></svg>Раздача промокодов:
												</span>
												<div class="quizMessage">
													PROMO1399
													<span class="chat-message-transaction-link color-white">
														1.00 <svg class="icon icon-coin bonus"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg> / Кол-во: 10
													</span>
												</div>
											</div>
                                        </div>
                                    ...
                                    <?php if(Auth::user() and $u->is_admin || $u->is_moder): ?>
									<div class="delete">
										<button type="button" class="btn btn-light" onclick="chatdelet(0)">
											<svg class="icon">
												<use xlink:href="/img/symbols.svg#icon-close"></use>
											</svg><span>Удалить</span>
										</button>
				...
				<div class="deposit-modal-component">
					<div class="wrap">
									...
									<div class="select-payment">
										...
										<div class="bottom-start dropdown">
											...
											<div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu" x-placement="bottom-start" data-placement="bottom-start">
												...
												<?php if(!is_null($settings->fk_mrh_ID)): ?>
						...
						<div class="deposit-section tab" data-type="withdraw">
							<div class="form-row">
								<label>
									<div class="form-label">Доступно для вывода (руб)</div>
									<div class="form-field">
										<div class="input-valid">
...
<?php endif; ?>
<?php /* /var/www/win2x/resources/views/layout.blade.php */ ?>