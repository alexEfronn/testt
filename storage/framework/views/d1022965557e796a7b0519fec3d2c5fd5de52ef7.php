            ...
            <div class="user-profile-overview-loop__left">
                <div class="flex-row">
                    <div class="user-profile-overview-loop__left-avatar">
                        ...
                        <p class="user-profile-overview-loop__left-since">На сайте с <?php echo e(($u->created_at)->format('d.m.Y')); ?></p>
                    </div>
                    ...
                    <div class="user-profile-overview-loop__left-resources__name"><?php echo e($u->username); ?></span></div>
						...
						<span class="user-profile-overview-loop__left-resources__money beatify-numbers"><?php echo e($u->balance); ?></span></div>
                ...
                <div class="user-profile-overview-loop__right-stats">
                    <div class="stat-block">
						...
						<svg class="icon">
                             ...
                             <span class="beatify-numbers"><?php echo e($sumBets->sum); ?></span>
                        </div>
                    </div>
                     <div class="stat-block">
						...
						<span class="beatify-numbers"><?php echo e($paysAmount); ?></span>
                        </div>
                    </div>
                    <div class="stat-block">
						...
						<span class="beatify-numbers"><?php echo e($withdrawAmount); ?></span>
                        </div>
                    </div>
                </div>
			<div class="user-profile-overview-stats-divisor"></div>
             <div class="next-rank user-profile-overview-ranks">
                    ...
                    <div class="progress-next-rank">  
                            ...
                            <div class="bets-progress">Ставок: <span class="progress-sum"><span class="beatify-numbers"><?php echo e($sumBets->sum); ?></span> / <span class="beatify-numbers">2000 </span> </span> <span class="myicon-coins"></span> <div class="fill" style="width:15%"></div></div>
                            <div class="deposit-progress">Депозитов: <span class="progress-sum"><span class="beatify-numbers"><?php echo e($paysAmount); ?></span> / <span class="beatify-numbers">50 </span> </span> <span class="myicon-coins"></span> <div class="fill" style="width:0%"></div></div>
                                            </div>
						...
						<label>
							...
							<div class="form-field">
								<div class="input-valid">
									<input class="input-field input-with-icon" id="profileName" value="<?php echo e($u->username); ?>" placeholder="Имя" >
