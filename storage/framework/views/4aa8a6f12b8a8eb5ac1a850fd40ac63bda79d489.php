						...
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item <?php echo e(Request::is('admin/bonus') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
								 ...
								 <?php if($u->superadmin): ?><li class="kt-menu__item <?php echo e(Request::is('admin/giveaway') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
									<a href="/admin/giveaway" class="kt-menu__link">
										...
										<span class="kt-menu__link-text">Раздачи</span>
									</a>
								</li><?php endif; ?>
								...
								<li class="kt-menu__item <?php echo e(Request::is('admin/tasks') ? 'kt-menu__item--active' : '' || Request::is('admin/tasks/*') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					<div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
						...
						<div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
							<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
								 <?php if($u->superadmin): ?><ul class="kt-menu__nav ">
									<li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here">
										<button type="button" class="btn btn-success socketStart">Включить сокет</button>
									</li>
									<li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here">
					...
					<div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
						<div class="kt-footer__copyright">
							2021 <?php echo e($settings->sitename); ?>. Developed by Malexenka with   <i style=color:red class="fas fa-heart"></i>. Contacts - <a style="color:blue" href="https://t.me/justfolked" target=_blank> Telegram </a>, <a style="color:red" href="https://vk.com/malexenka" target=_blank> Vkontakte </a>
						</div>
					</div>
