				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="mines" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-3">
								<label>Минимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Минимальная сумма ставки" value="<?php echo e($settings->mines_min_bet); ?>" name="mines_min_bet">
							</div>
							<div class="col-lg-3">
								<label>Максимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Максимальная сумма ставки" value="<?php echo e($settings->mines_max_bet); ?>" name="mines_max_bet">
							</div>
						</div>
					</div>
