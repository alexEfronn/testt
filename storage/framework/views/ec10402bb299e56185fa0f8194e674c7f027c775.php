                        ...
                        <div class="bet-form">
                            ...
                            <div class="command-type btnToggle">
								<button class="btn-bet bet-red" data-team="red">
									<div class="bet-chance">
										<div class="chance-text">
											<span id="red_persent"><?php echo e($chances[0]); ?>%</span><br>Красная
								...
								<button class="btn-bet bet-blue" data-team="blue">
									<div class="bet-chance">
										<div class="chance-text">
											<span id="blue_persent"><?php echo e($chances[1]); ?>%</span><br>Синяя
				...
				<div class="game_Wheel">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Мин. сумма: <span id="minBet"><?php echo e($settings->battle_min_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Макс. сумма: <span id="maxBet"><?php echo e($settings->battle_max_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
					...
					<div class="wheel-game">
						<div class="wheel-content">
							...
							<div class="time">
								<div class="block">
									<div class="title">Банк команд</div>
...
<div class="section bets-section">
	<div class="container">
		<div class="game-stats">
			...
			<div class="table-stats-wrap" style="min-height: 50px; max-height: 100%;">
					...
					<table class="table">
						<tbody>
							...
							<tr>
								...
								<td><span class="bet-type bet_<?php echo e($b->color); ?>"><?php echo e($b->color == 'red' ? 'Красная' : 'Синяя'); ?></span></td>
							</tr>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</tbody>
					</table>
