...
<div class="section">
    <div class="faq-component">
        <div class="faq-head">
            ...
            <div class="faq-link"><a class="btn btn-light" href="<?php echo e($settings->vk_support_link); ?>" target="_blank">&nbsp; Написать в поддержку &nbsp;</a></div>
            <?php endif; ?>
        </div>
        <div class="faq-item">
            <div class="caption">
            ...
            <div class="faq-content">
                <p><?php echo e($settings->sitename); ?> - это увлекательные и доказуемые честные мини-игры.</p>
        ...
        <div class="faq-item">
            ...
            <div class="faq-content">
                ...
                <p>Каждый пользователь может проверить исход любой игры полностью детерминированным способом. Предоставляя один параметр - клиентский хэш, на входы генератора случайных чисел, <?php echo e($settings->sitename); ?> не может манипулировать результатами в свою пользу.</p>
                <p>Генератор случайных чисел <?php echo e($settings->sitename); ?> позволяет каждой игре запрашивать любое количество случайных чисел из заданного начального числа клиента, начального числа сервера и одноразового номера.</p>
            </div>
        </div>
        <div class="faq-item">
            <div class="caption">
