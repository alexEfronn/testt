                ...
                <div class="form_container">
                    ...
                    <div class="form_info">
                        <div class="form_wrapper group" style="display: none">
                        	<div class="form_text">
								<span>Вступите <a href="<?php echo e($settings->vk_url); ?>" target="_blank">в нашу группу</a></span>
								<br><span>и получайте до <strong><?php echo e($max); ?> монет на свой баланс</strong></span>
                        	</div>
							<div class="form_block">
								<?php if(!$check): ?>
								<div class="form_value"><?php echo e($settings->bonus_group_time); ?> мин<div class="form_text">перезарядка</div></div>
                        ...
                        <div class="form_wrapper refs" style="display: none">
                        	<div class="form_text">
                        		Пригласите <strong><?php echo e($settings->max_active_ref); ?> активных рефералов <div class="popover-tip-block" id="purposeTip"><div class="popover-tip-icon"><svg class="icon icon-help"><use xlink:href="/img/symbols.svg#icon-help"></use></svg></div></div></strong>
                        		<br> и получите до <strong><?php echo e($max_refs); ?> монет на бонусный счет</strong>
                        	</div>
                        	<div class="form_block">
                        		<?php if(!$refLog): ?>
                        		<div class="form_value"><?php echo e($activeRefs); ?> / <?php echo e($settings->max_active_ref); ?><div class="form_text">рефералов</div></div>
                        		<span id="spin-wheel-button" class=""><button type="button" class="btn" data-toggle="modal" data-target="#captchaModal">Крутить колесо</button></span>
                        		<?php else: ?>
