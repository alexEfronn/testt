...
|
*/
Route::get('/', ['as' => 'index', 'uses' => 'PagesController@games']);
...
Route::post('/api/mines/bet', ['as' => 'mines.bet', 'uses' => 'MinesController@bet']);
Route::post('/api/mines/mine', ['as' => 'mines.mine', 'uses' => 'MinesController@mine']);
Route::post('/api/mines/finish', ['as' => 'mines.finish', 'uses' => 'MinesController@finish']);
Route::get('/tower', ['as' => 'crash', 'uses' => 'TowerController@index']);
Route::get('/cases', ['as' => 'crash', 'uses' => 'CasesController@index']);
...
Route::any('/profile/changeName', 'PagesController@changeName');
Route::any('/profile/changeAvatar', 'PagesController@changeAvatar');
/*TEST*/
Route::get('/hilo', ['as' => 'hilo', 'uses' => 'HiLoController@index']);
Route::get('/getCard', ['as' => 'hilo', 'uses' => 'HiLoController@getRandom']);
...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/pay/send', 'PagesController@paySend');
	Route::post('/pay/create', 'PagesController@sendCreate');
	Route::post('/withdraw', 'PagesController@userWithdraw');
	Route::post('/withdraw/cancel', 'PagesController@userWithdrawCancel');
	Route::get('/settings', 'SettingsController@switchTheme');
...
Route::group(['prefix' => '/admin', 'middleware' => 'auth', 'middleware' => 'access:admin'], function () {
	...
	Route::get('/giveaway', 'AdminController@giveaway');
	...
	Route::post('/tasks/add', 'AdminController@addTask');
	Route::post('/tasksAjax', 'AdminController@tasksAjax');
});
