		...
		<div class="kt-portlet__head">
			<div class="kt-portlet__head-toolbar">
				<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-danger nav-tabs-line-2x nav-tabs-line-right" role="tablist">
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#mines" role="tab" aria-selected="false">
							Mines
						</a>
					</li>
					<li class="nav-item">
				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="jackpot" role="tabpanel">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Введите процент" value="{{$settings->jackpot_commission}}" name="jackpot_commission">
						</div>
						@foreach($rooms as $r)
						<div class="kt-section">
							<h3 class="kt-section__title">
							...
							<div class="form-group row">
								...
								<div class="col-lg-3">
									...
									<input type="text" class="form-control" name="min_{{$r->name}}" value="{{$r->min}}" placeholder="Минимальная сумма ставки">
								</div>
								<div class="col-lg-3">
									<label>Максимальная сумма ставки:</label>
									<input type="text" class="form-control" name="max_{{$r->name}}" value="{{$r->max}}" placeholder="Максимальная сумма ставки">
								</div>
								<div class="col-lg-3">
									<label>Максимальное кол-во ставок для игрока:</label>
									<input type="text" class="form-control" name="bets_{{$r->name}}" value="{{$r->bets}}" placeholder="Макс. кол-во ставок для игрока">
								</div>
							</div>
						</div>
						@endforeach
					...
					<div class="tab-pane" id="wheel" role="tabpanel">
						<div class="form-group row">
							...
							<div class="col-lg-4">
								<label>Минимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Минимальная сумма ставки" value="{{$settings->wheel_min_bet}}" name="wheel_min_bet">
							</div>
							<div class="col-lg-4">
								<label>Максимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Максимальная сумма ставки" value="{{$settings->wheel_max_bet}}" name="wheel_max_bet">
							</div>
						</div>
					</div>
					<div class="tab-pane" id="crash" role="tabpanel">
						<div class="form-group row">
							...
							<div class="col-lg-4">
								<label>Минимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Минимальная сумма ставки" value="{{$settings->crash_min_bet}}" name="crash_min_bet">
							</div>
							<div class="col-lg-4">
								<label>Максимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Максимальная сумма ставки" value="{{$settings->crash_max_bet}}" name="crash_max_bet">
							</div>
						</div>
					</div>
					<div class="tab-pane" id="pvp" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-4">
								<label>Комиссия игры в %:</label>
								<input type="text" class="form-control" placeholder="Макс. кол-во активных игр для игрока" value="{{$settings->flip_commission}}" name="flip_commission">
							</div>
							<div class="col-lg-4">
								<label>Минимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Минимальная сумма ставки" value="{{$settings->flip_min_bet}}" name="flip_min_bet">
							</div>
							<div class="col-lg-4">
								<label>Максимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Максимальная сумма ставки" value="{{$settings->flip_max_bet}}" name="flip_max_bet">
							</div>
						</div>
					</div>
					<div class="tab-pane" id="battle" role="tabpanel">
						<div class="form-group row">
							...
							<div class="col-lg-3">
								<label>Минимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Минимальная сумма ставки" value="{{$settings->battle_min_bet}}" name="battle_min_bet">
							</div>
							<div class="col-lg-3">
								<label>Максимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Максимальная сумма ставки" value="{{$settings->battle_max_bet}}" name="battle_max_bet">
							</div>
							<div class="col-lg-3">
								<label>Комиссия игры в %:</label>
					...
					<div class="tab-pane" id="dice" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-6">
								<label>Минимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Минимальная сумма ставки" value="{{$settings->dice_min_bet}}" name="dice_min_bet">
							</div>
							<div class="col-lg-6">
								<label>Максимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Максимальная сумма ставки" value="{{$settings->dice_max_bet}}" name="dice_max_bet">
							</div>
						</div>
					</div>
					<div class="tab-pane" id="hilo" role="tabpanel">
						<div class="form-group row">
							...
							<div class="col-lg-3">
								<label>Минимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Минимальная сумма ставки" value="{{$settings->hilo_min_bet}}" name="hilo_min_bet">
							</div>
							<div class="col-lg-3">
								<label>Максимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Максимальная сумма ставки" value="{{$settings->hilo_max_bet}}" name="hilo_max_bet">
							</div>
							<div class="col-lg-3">
					...
					<div class="tab-pane" id="tower" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-3">
								<label>Минимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Минимальная сумма ставки" value="{{$settings->tower_min_bet}}" name="tower_min_bet">
							</div>
							<div class="col-lg-3">
								<label>Максимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Максимальная сумма ставки" value="{{$settings->tower_max_bet}}" name="tower_max_bet">
							</div>
						</div>
					</div>
					<div class="tab-pane" id="mines" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-3">
								<label>Минимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Минимальная сумма ставки" value="{{$settings->mines_min_bet}}" name="mines_min_bet">
							</div>
							<div class="col-lg-3">
								<label>Максимальная сумма ставки:</label>
								<input type="text" class="form-control" placeholder="Максимальная сумма ставки" value="{{$settings->mines_max_bet}}" name="mines_max_bet">
							</div>
						</div>
					</div>
					<div class="tab-pane" id="fake" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-6">
								...
								<input type="text" class="form-control" placeholder="Минимальная сумма ставки для фейка" value="{{$settings->fake_min_bet}}" name="fake_min_bet">
							</div>
							<div class="col-lg-6">
								<label>Максимальная сумма ставки для фейка:</label>
								<input type="text" class="form-control" placeholder="Максимальная сумма ставки для фейка" value="{{$settings->fake_max_bet}}" name="fake_max_bet">
							</div>
						</div>
					</div>
				</div>
