        ...
        <div class="tasks hasBanner">
            <div class="task-nav">
                ...
                <div class="task-filter">
                    <a href="/tasks" type="button" class="btn btn-light">
                    ...
                    <a type="button" href="/tasks/myhistory"  class="btn btn-light isActive">
                        ...
                        <div class="item">
                            <div class="task-box">
                                ...
                                <div class="task-box-date">
                                    ...
                                    <a href="/tasks/{{$task->id}}" class="btn btn-light" >Посмотреть</a > 
                                </div>
                            </div>
                        </div>
                        @empty
                            <div class="empty-list">Вы еще не участвовали в заданиях</div>  
                        @endforelse
