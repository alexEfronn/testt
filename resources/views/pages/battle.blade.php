                        ...
                        <div class="bet-form">
                            ...
                            <div class="command-type btnToggle">
								<button class="btn-bet bet-red" data-team="red">
									<div class="bet-chance">
										<div class="chance-text">
											<span id="red_persent">{{$chances[0]}}%</span><br>Красная
								...
								<button class="btn-bet bet-blue" data-team="blue">
									<div class="bet-chance">
										<div class="chance-text">
											<span id="blue_persent">{{$chances[1]}}%</span><br>Синяя
				...
				<div class="game_Wheel">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Мин. сумма: <span id="minBet">{{$settings->battle_min_bet}}</span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Макс. сумма: <span id="maxBet">{{$settings->battle_max_bet}}</span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
					...
					<table class="table">
						<tbody>
							...
							<tr>
								...
								<td><span class="bet-type bet_{{$b->color}}">{{$b->color == 'red' ? 'Красная' : 'Синяя'}}</span></td>
							</tr>
							@endforeach
						</tbody>
					</table>
