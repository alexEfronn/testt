$(document).ready(function() {
    ...
    socket.on('jackpot', r => {
        ...
        if(r.type == 'slider' && room == r.room) {
            ...
            if(ngtimerStatus&&r.data.users) { 
                $('.n_progressbar_main').addClass('animated fadeOutUp');
            ...
            // let users = mulAndShuffle(r.data.users, 1.21),
                ...
                $("#winner-ticket").html(`<span style="position: relative;"><div id="escapingBallG"><div id="escapingBall_1" class="escapingBallG"></div></div></span>`);
                setTimeout(function () {
                    $('.n_progressbar_main').removeClass('animated fadeOutUp');
                    $('.n_progressbar_main').addClass('hidden');
        ...
        if(r.type == 'newGame') {
			...
			if(room == r.room) {
                ...
                $('.n_progressbar_main').removeClass('hidden');
                $('#RuletkaSkrita').removeClass('animated bounceInRight');
                $('.end-game').addClass('hidden');
    ...
    function updateBonus(bonus, bonusType) {
        ...
        let bet =  `
            <li style="background: #fff;    height: 94px !important;
            align-items: center;
    ...
    function JackpotParse(res) {
        ...
        if(res.bonus > 0)  {
            ...
            bets += `
                <li style="background: #4ae757;    height: 94px !important;
                align-items: center;
                display: flex;justify-content: space-between;">
                    <div class="avatar">
                        <img
